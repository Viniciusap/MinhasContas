...
namespace MinhasContas.Controllers
{
    public class RegistersController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                register = register.Where(s => s.Title.Contains(searchString));
            }
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,Title,Value,CreationData,DueData,PayData")] Register register)
        {
